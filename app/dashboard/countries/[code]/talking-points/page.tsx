...
export const generateMetadata = ({
  ...
  return {
    title: country
      ? `${country.name} Talking Points | Staff Portal`
      : "Country Talking Points | Staff Portal",
    description: country
      ? `Talking points for ${country.name}`
      : "Country talking points",
  };
};

export default function CountryTalkingPointsPage({
  params,
}: {
  params: { code: string };
}) {
